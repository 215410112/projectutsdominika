...
fun MovieCard() {
    ...
    val movies = listOf(
        Movie(R.drawable.filem1, "Informasi tambahan Film 1", "Deskripsi Film 1"),
        Movie(R.drawable.filem2, "Informasi tambahan Film 2", "Deskripsi Film 2"),
        Movie(R.drawable.filem3, "Informasi tambahan Film 3", "Deskripsi Film 3"),
